      ...
      <div class="auth-form-section">
        <div class="auth-container">
          ...
          <div class="social-login">
            <button pButton class="social-btn google-btn" (click)="registerWithGoogle()">
            ...
            <button pButton class="social-btn github-btn" (click)="registerWithGithub()">
          ...
          <form [formGroup]="registerForm" class="login-form" (ngSubmit)="onSubmit()">
            <div class="form-group">
              ...
              <input pInputText id="fullName" type="text" formControlName="fullName" placeholder="Enter your full name" />
              @if (registerForm.get('fullName')?.invalid && registerForm.get('fullName')?.touched) {
                <small class="error">Please enter your full name</small>
              }
            </div>
            ...
            <div class="form-options">
              <div class="terms-checkbox">
                ...
                <label for="acceptTerms">I agree to the <a href="#">Terms of Service</a> and <a href="#">Privacy Policy</a></label>
              </div>
            </div>
            
            <button pButton type="submit" label="Create Account" class="submit-btn" [loading]="loading()" [disabled]="registerForm.invalid"></button>
          </form>
...
export class RegisterComponent {
  ...
  async onSubmit(): Promise<void> {
    ...
    if (result.success) {
      this.messageService.add({
        ...
        detail: 'Welcome to Digital Atelier! Please sign in.'
      });
  ...
  async registerWithGithub(): Promise<void> {
    const result = await this.authService.registerWithGithub();
    if (!result.success) {
      this.messageService.add({ severity: 'info', summary: 'Info', detail: result.error });
    }
  }
